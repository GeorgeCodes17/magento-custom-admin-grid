...
namespace George\CustomGridAdmin\Block\Adminhtml\Widget;

use Magento\Framework\Data\Form\Element\AbstractElement;

class BannerChooser extends \Magento\Backend\Block\Template
{
    /**
    ...
    /**
     * Prepare banner choose element HTML
     *
    ...
    public function prepareElementHtml(AbstractElement $element)
    {
        ...
        $chooser = $this->getLayout()->createBlock(\Magento\Backend\Block\Widget\Button::class)
            ...
            ->setOnClick('MediabrowserUtility.openDialog(\'' . $sourceUrl . '\', 0, 0, "Media Browser", {})')
